const BLOG = {
  ...
  link: 'fiskja.com',
  description: 'Dette finner du på Fiskja',
  lang: 'no', // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'es-ES']
  ...
  ogImageGenerateURL: 'https://www.fiskja.com/', // The link to generate OG image, don't end with a slash
  socialLink: 'https://twitter.com/Fiskja',
  seo: {
    keywords: ['Blog', 'Fisk', 'Fiskemat', 'Fiskerett', 'Fisker', 'Laks', 'Torsk', 'Sild'],
